...
class Camera
{
  public:
    ...
    Matrix          ViewTransform(void) { Matrix m; return m;};    // YOU IMPLEMENT THIS
    Matrix          CameraTransform(void) { Matrix m; return m;};  // YOU IMPLEMENT THIS
    Matrix          DeviceTransform(void) { Matrix m; return m;};  // YOU IMPLEMENT THIS
};
