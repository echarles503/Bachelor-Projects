 ...
 */
       ...
       */
       t.setVertices(0, x1, y1, z1);
       t.setVertices(1, x2, y2, z2);
       t.setVertices(2, x3, y3, z3);
       ...
       */
       t.setVertexColor(0, Pixel(r[0], g[0], b[0]));
       t.setVertexColor(1, Pixel(r[1], g[1], b[1]));
       t.setVertexColor(2, Pixel(r[2], g[2], b[2]));
