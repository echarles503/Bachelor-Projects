...
const char *phase345FragmentShader =
  ...
  "  float t1 = (data-1) / (4.5 - 1.0);\n"
  "  float t2 = (data-4.5) / (6.0 - 4.5);\n"

  "  float r1 = .25 + t1 * (1.0 - .25);\n"
  "  float g1 = .25 + t1 * (1.0 - .25);\n"
  "  float b1 = 1.0;\n"
  
  "  float r2 = 1.0;\n"
  "  float g2 = 1.0 + t2 * (.25 - 1);\n"
  "  float b2 = 1.0 + t2 * (.25 - 1);\n"
